...
function Vector#(1024, Word) testProgram();
    ...
    prog[5] = 32'h00500513;  // @ 0x80000014
    prog[6] = 32'h06400593;  // @ 0x80000018
    prog[7] = 32'h80001337;  // @ 0x8000001c
    prog[8] = 32'h00100393;  // @ 0x80000020
    prog[9] = 32'h00732023;  // @ 0x80000024
    prog[10] = 32'h0000006f;  // @ 0x80000028
